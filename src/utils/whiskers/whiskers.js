...
// TODO:
//
//  - forked from https://github.com/gsf/whiskers.js/
//  - removed Node/express code
//  - added ES6 export
//  - need to convert to TypeScript and split into a separate project
//
...
whiskers.compile = function (template) {
  ...
  // replace tags
  template = template.replace(/(\\*){(?:([\w_.\-@:]+)|>([\w_.\-@:]+)|for +([\w_\-@:]+) +in +([\w_.\-@:]+)|if +(not +|)([\w_.\-@:]+)|\/(for|if))}/g, function (
    str,
    escapeChar,
    key,
    partial,
